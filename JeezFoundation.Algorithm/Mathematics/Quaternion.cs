...
public class Quaternion<T>
{
    ...
    #endregion Multiply (Quaternion * Quaternion)
    ...
    #endregion Multiply (Quaternion * Vector)
    ...
    #endregion Multiply (Quaternion * Scalar)
