...
{
    public class ScheduleRepository : DapperRepository<SysSchedule>, IScheduleRepository
    {
        public ScheduleRepository(IDbConnection connection, SqlGeneratorConfig config) : base(connection, config)
        {
